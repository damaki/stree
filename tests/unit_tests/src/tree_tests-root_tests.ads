...
--  This package tests the Root function.

package Tree_Tests.Root_Tests is

   type Test_Fixture is new AUnit.Test_Fixtures.Test_Fixture with null record;

   procedure Test_Root_Empty (T : in out Test_Fixture);
   procedure Test_Root_Non_Empty (T : in out Test_Fixture);
